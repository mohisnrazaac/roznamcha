...
while to_visit and count < 100:
    ...
    try:
        ...
        for link in links:
            if link.startswith('mailto:') or link.startswith('tel:') or link.startswith('#') or '.js' in link or '.css' in link or '.png' in link or '.svg' in link:
                continue
