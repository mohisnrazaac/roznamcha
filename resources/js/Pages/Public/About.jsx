        ...
        <PublicLayout variant="inner">
            ...
            <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-10">
                ...
                <section className="bg-white border border-slate-200 rounded-2xl p-6 space-y-3">
                    ...
                    <p className="text-base text-slate-700">
                        Mohsin is the Founder of Roznamcha.pk, a Software Architect, and the founder behind the product. With 19 years of experience
                ...
                <section className="bg-white border border-slate-200 rounded-2xl p-6 space-y-3">
                    ...
                    <p className="text-base text-slate-700">
                        ...
                        <a href="mailto:support@roznamcha.pk" className="font-semibold text-[#001a4a] underline">
