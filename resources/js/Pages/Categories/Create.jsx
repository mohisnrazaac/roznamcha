// Purpose: Panel form to add user-owned categories. Date: 2026-02-22. Author: Codex.
    ...
    <ControlRoomLayout active="panel-categories" user={props.auth?.user}>
      <div className="p-6 md:p-10 text-white space-y-6 max-w-2xl">
        <div>
          ...
          <h1 className="mt-2 text-2xl font-semibold">Add Category</h1>
          <p className="text-sm text-slate-400">Custom categories only appear in your own kharcha and reports.</p>
        </div>
