...
$commands = [
    'php artisan migrate --path=database/migrations/2025_12_01_000000_create_events_table.php --force',
    'php artisan migrate --path=database/migrations/2025_12_01_000010_add_feature_hooks_to_blog_posts_table.php --force',
];
...
echo "Activation migrations completed.\n";
