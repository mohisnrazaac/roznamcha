...
import { S as SeoHead, b as buildWebPageSchema } from "./SeoHead-Dkivr5Te.js";
import "util";
import "stream";
import "path";
import "http";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[1.1fr_0.9fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 space-y-3", children: budget.categories.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryRow, { item }, item.category)) }),
          !isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-[1.5rem] border border-slate-200 bg-slate-50 p-6 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-[#001a4a]", children: "Save this budget template for your household" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-slate-600", children: "Sign up to track your monthly spending against this template, or login to download the free PDF." }),
