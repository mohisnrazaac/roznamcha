import { R as React, j as jsxRuntimeExports, a as usePage, u as useForm, L as Link_default } from "../ssr.js";
import { P as PublicLayout } from "./PublicLayout-Cdp3p9pO.js";
import { S as SeoHead, b as buildWebPageSchema } from "./SeoHead-1rNy1Vsq.js";
import "util";
import "stream";
import "path";
import "http";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold uppercase tracking-[0.35em] text-[#8c5a00]", children: "Sponsored" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 text-xl font-semibold text-[#001a4a]", children: title })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full border border-[#001a4a]/10 bg-white/80 px-3 py-1 text-xs font-medium text-slate-500", children: "AdSense" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-2xl text-sm leading-6 text-slate-600", children: description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 rounded-[1.25rem] border border-white bg-white/90 p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ins",
          {
            ref: adRef,
