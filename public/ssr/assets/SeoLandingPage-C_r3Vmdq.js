...
function SeoLandingPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { variant: "inner", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[#f7f3ea]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8", children: [
      ...
      interactiveWidget || children ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10", children: interactiveWidget || children }) : null,
      dataPoints && dataPoints.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4", children: dataPoints.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-slate-200 bg-white p-5 shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SarkariTayariPromoCard, {})
        ] })
      ] })
    ] }) })
  ] });
