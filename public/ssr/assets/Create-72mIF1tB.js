...
function CategoriesCreate() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ControlRoomLayout, { active: "categories", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-10 text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-2 text-xl font-semibold", children: "Add Category" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400", children: "These become global defaults for every user account." })
    ] }),
