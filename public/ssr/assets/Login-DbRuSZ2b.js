...
import "events";
import "process";
function Login({ returnTo = "/dashboard" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-slate-950 flex items-center justify-center px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Head_default, { title: "Login" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md rounded-2xl bg-slate-900/90 border border-slate-800 p-8 shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-white", children: "Sign in to Roznamcha" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-400", children: "Track household survival with your cockpit." })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-6 text-center text-sm text-slate-400", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link_default,
          {
            href: data.return_to && data.return_to !== "/dashboard" ? `/register?return_to=${encodeURIComponent(data.return_to)}` : "/register",
