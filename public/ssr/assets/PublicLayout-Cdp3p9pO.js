...
function CookieConsent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-0 right-0 z-50 bg-[#001a4a] text-white border-t border-white/10 px-4 py-4 sm:px-6 shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-white/90 text-center md:text-left", children: [
      'We use cookies to personalize content, analyze our traffic, and serve relevant advertisements through Google AdSense. By clicking "Accept", you consent to our use of cookies. Read our',
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/privacy-policy", className: "underline text-yellow-300 hover:text-yellow-200", children: "Privacy Policy" }),
      " ",
      "to learn more."
    ] }),
...
function PublicLayout({ children, variant = "landing" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.wrapper, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-transparent text-center px-4 py-8 text-sm text-slate-500 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm font-medium", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/about", className: "text-[#001a4a] hover:underline", children: "About Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/contact", className: "text-[#001a4a] hover:underline", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/privacy-policy", className: "text-[#001a4a] hover:underline", children: "Privacy Policy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/terms", className: "text-[#001a4a] hover:underline", children: "Terms of Service" }),
